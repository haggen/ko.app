...
!function (factory) {
  ...
  app.render = function(template) {
    ...
    template.load(configuration.templatesPath + app.template + configuration.templatesExt, function() {
      ko.applyBindings({
  ...
  //overrides default framework configurations
  app.configure = function (config) {
    configuration = $.extend(configuration, config);
  };
